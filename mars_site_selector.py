...
# Looks for suitable rectangular regions
class Search():
...
# Calculating rectangle statistics and moving the rectangle        
...
# Drawing all the rectangles on the MOLA map as a quality control step
...
# Sorting and high grading the rectangles based on their statistics
    def sort_stats(self):
...
# Drawing filtered rectangles and latitude lines on MOLA map
    def draw_filtered_rects(self, image, filtered_rect_list):
        ...
        # Draw latitude limites for the equator
...
# Making the final display using the color MOLA map
